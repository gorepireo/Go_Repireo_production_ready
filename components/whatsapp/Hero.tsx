  ...
  return (
    <section id="top" className="hero">
      ...
      <svg className="hero-divider" viewBox="0 0 1080 40" preserveAspectRatio="none" aria-hidden="true">
        <line x1="0" y1="20" x2="500" y2="20" stroke="#b8703c" strokeWidth="6" strokeLinecap="round" />
        <path d="M 580 20 L 610 8 L 640 32 L 670 8 L 700 32 L 730 8 L 760 20"
              fill="none" stroke="#f0b429" strokeWidth="3" strokeLinecap="round" />
        <line x1="760" y1="20" x2="1080" y2="20" stroke="#f0b429" strokeWidth="3" strokeLinecap="round" strokeDasharray="1 14" />
      </svg>
