  ...
  return (
    <div className="flex flex-col min-h-screen bg-[#F8FAFC] pb-32 pt-6">
      ...
      <section className="px-4">
        <div className="relative bg-gradient-to-br from-[#e8f0fe] to-[#d6e4ff] rounded-3xl p-6 overflow-hidden min-h-[360px] flex flex-col justify-between">
          <div className="relative z-10 space-y-4 max-w-[65%]">
            ...
            <h1 className="text-4xl md:text-5xl font-black leading-[0.95] tracking-tight text-slate-900">
            ...
            <div className="space-y-3">
              <div className="flex items-center gap-2">
                ...
                <span className="text-[10px] text-slate-600 font-medium">Trusted by 10,000+ customers</span>
              </div>
              <p className="text-xs text-slate-600 leading-relaxed max-w-[200px]">
                Book trusted professionals for your home repairs, maintenance & installations.
              </p>
            </div>

            <div className="flex flex-wrap gap-2 pt-2 relative z-20">
              <Link href="/services" className="bg-[#007AFF] text-white px-4 py-2.5 rounded-full text-[10px] font-bold uppercase tracking-wide flex items-center gap-1 hover:bg-blue-600 active:scale-95 transition-all">
                Book a Service <ChevronRight size={14} />
              </Link>
              <button 
                onClick={() => {
                  if (locationText === 'Available Near You' || locationText === 'Location Unavailable') {
                     // trigger location prompt again if possible, or just let it be
                     navigator.geolocation.getCurrentPosition(() => window.location.reload());
                  }
                }}
                className="bg-white/80 backdrop-blur-sm text-slate-700 px-4 py-2.5 rounded-full text-[10px] font-bold uppercase tracking-wide flex items-center gap-1.5 border border-white shadow-sm"
              >
                <MapPin size={12} className={isLocating ? "text-slate-400 animate-pulse" : "text-[#FF6B00]"} /> 
          ...
          <div className="absolute -right-16 -bottom-4 w-[110%] max-w-[340px] h-72 z-0 pointer-events-none">
            <img src="/hero_house_3d.png" alt="House Repairs" className="w-full h-full object-contain" />
          </div>
        </div>
      </section>
      ...
      <section className="mt-8">
        <div className="flex justify-between items-end px-4 mb-4">
          <h2 className="text-sm font-black uppercase tracking-tight text-slate-900">
            Popular <span className="text-[#007AFF]">Services</span>
          </h2>
