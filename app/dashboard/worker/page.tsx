      ...
      <div className="max-w-4xl mx-auto px-4 md:px-6 pt-12 space-y-10">
          ...
          <div className="flex items-center justify-between">
            <div>
              <h1 className="text-4xl md:text-7xl font-bold uppercase tracking-tighter leading-none skew-title">
                COMMAND <br />
                <span className="text-[#007AFF]">CONSOLE.</span>
              </h1>
              <p className="tactile-label tracking-[0.3em] mt-2">Tactical Mission Interface</p>
            </div>
        ...
        <div className="grid grid-cols-2 md:grid-cols-2 gap-4">
          <div className="king-card flex flex-col justify-between group">
            <div>
              <p className="tactile-label">Duty Protocol</p>
          ...
          <div className="king-card flex flex-col justify-between">
            <div>
              <p className="tactile-label">Total Bounty</p>
        ...
        <div className="space-y-6">
          <div className="flex items-center justify-between">
             <h3 className="tactile-label !text-slate-400">Interception Feed</h3>
             <span className="tactile-label font-bold text-[#007AFF]">{activeJobs.length} SIGS</span>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-3">
                ...
                >
                  <div className="flex items-start justify-between">
                    ...
                    <div className="text-right">
                      <p className="tactile-label !text-slate-300">BOUNTY</p>
                  ...
                  <button className="btn-primary !py-3 !text-[10px] w-full">
                    INITIALIZE MISSION
                  </button>
                </motion.div>
              ))}
            ...
            {activeJobs.length === 0 && (
              <div className="col-span-full king-card py-20 text-center flex flex-col items-center gap-4 opacity-30 border-dashed border-slate-200">
                ...
                <p className="tactile-label">Awaiting Operational Signals...</p>
              </div>
            )}
          </div>
        </div>
